...
import type { AgentInfo, RealmDetail, UserListItem } from "@/lib/contracts";
...
export function AddMemberModal({
  ...
  // Filter out already-members (agents already carry their realm array)
  const available =
    type === "agent"
      ? agents.filter((a) => !a.agentRealms?.some((r) => r.realmId === realm.id))
      : users;
