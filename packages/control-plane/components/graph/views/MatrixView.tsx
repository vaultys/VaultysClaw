...
interface UserRow { node: GraphNode; depth: number }
...
interface CellData { caps: string[]; isDelegation: boolean }
              ...
              >
                <div className="flex flex-col items-center gap-1.5">
                  <div
                    ...
                    style={{ backgroundColor: agent.isOnline ? "#22c55e" : "#475569" }}
                      ...
                      {expanded ? (
                        ...
                        <div className="flex flex-col items-center gap-0.5">
                          <div className="flex gap-1 justify-center">
                            {hasGrant && (
                              <span className="inline-block w-2 h-2 rounded-full bg-amber-500" title="Grant" />
                            )}
                            {hasDelegation && (
