...
import type { UserConnectionPhase, UserConnectInfo } from "@/hooks/useVaultysConnect";
...
export default function QRCodeScreen({ connectInfo, phase, p2pUrl, onSwitchP2P, onRetry }: QRCodeScreenProps) {
