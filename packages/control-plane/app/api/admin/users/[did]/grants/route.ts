/**
 * GET  /api/admin/users/[did]/grants  — list grants for a user
 * POST /api/admin/users/[did]/grants  — create a grant + sign delegation cert + push to agent
 * Owner-only.
 */
...
const handlers = createNextRoute(adminContract.users, {
  ...
  // ── POST /api/admin/users/:did/grants ───────────────────────────────────────────
