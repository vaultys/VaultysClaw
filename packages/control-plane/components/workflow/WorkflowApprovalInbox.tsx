  ...
  return (
    <div className="border-b border-neutral-200 bg-background-200">
      ...
      {pendingApprovals.map((approval) => (
        <div
          key={approval.id}
          className="border-b border-warning-200 dark:border-warning-800 bg-warning-50 dark:bg-warning-900/20"
        >
          <div
          ...
          >
            ...
            />
            <span className="text-sm font-medium text-warning-900 dark:text-warning-200 flex-1">
          ...
          {expanded === approval.id && (
            <div className="px-4 pb-4 space-y-3">
              {/* Details */}
              <div className="grid grid-cols-2 gap-2 text-xs text-warning-800 dark:text-warning-300 bg-warning-100/60 dark:bg-warning-900/30 rounded-md p-3">
                <div>
              ...
              {approval.node_message && (
                <div className="text-sm text-warning-900 dark:text-warning-200 bg-warning-100 dark:bg-warning-900/40 rounded-md p-3">
              ...
              {approval.step_input && (
                <div>
                  <p className="text-xs font-semibold text-warning-800 dark:text-warning-300 mb-1">
                    Workflow input
                  </p>
              ...
              {/* Comment */}
              <div>
                <label className="text-xs font-medium text-warning-800 dark:text-warning-300 block mb-1">
                  Comment (optional)
                </label>
                <textarea
                  rows={2}
      ...
      {notifications.map((notif) => (
        <div
          key={notif.id}
          className="flex items-start gap-3 px-4 py-3 border-b border-neutral-200 bg-primary-50 dark:bg-primary-900/10"
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            {notif.step_input && (
              <p className="text-xs text-primary-700 dark:text-primary-400 mt-0.5 truncate">
