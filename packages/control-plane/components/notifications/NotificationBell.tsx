        ...
        <div className="absolute right-0 top-full mt-1.5 w-80 bg-background-100 border border-neutral-300 rounded-xl shadow-2xl shadow-black/40 z-50 overflow-hidden">
          ...
          {total > notifications.length && (
            <Link
              ...
              className="block px-3 py-2.5 text-center text-xs font-medium text-primary-600 hover:text-primary-700 border-t border-neutral-200 hover:bg-background-200/60 transition-colors"
            >
              See all notifications ({total})
            </Link>
          )}
        </div>
      )}
