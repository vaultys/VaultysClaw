/**
 * GET    /api/admin/users/[did]  — Get a single user (admin-only).
 * PATCH  /api/admin/users/[did]  — Update a user's profile fields (owner-only).
 * DELETE /api/admin/users/[did]  — Remove a user and all their grants (owner-only).
 */
