...
import { userContract, BucketPoint } from "@/lib/contracts";
import { createNextRoute } from "@/lib/api/ts-rest/next-route";

/**
 * GET /api/agents/:did/token-usage — user-facing equivalent of the admin
 * token-usage endpoint. Same daily/monthly bucketing, gated by `canAccessAgent`.
 */
