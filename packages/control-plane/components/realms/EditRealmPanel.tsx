...
import { realmsClient } from "@/lib/api/ts-rest/client";
import type { RealmDetail } from "@/lib/contracts";
import { PRESET_COLORS } from "./types";

/** Inline editor for a realm's name, description and color. */
export function EditRealmPanel({
  realm,
  onClose,
  onSaved,
}: {
  ...
  const [desc, setDesc] = useState(realm.description ?? "");
  const [color, setColor] = useState(realm.color);
